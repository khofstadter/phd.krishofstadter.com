...
![BCMI design flowchart (top) and BCI steps (bottom).](../assets/img/bcmi-design-flowchart.jpg)<center>Figure 6.1: BCMI design fowchart (top) and BCI steps (bottom).</center>
...
[^corineprot]: The new neurofeedback protocol I have been developing for this artistic setting is based on Flor-Henry, Shapiro and Sombrun (2017)demonstrating neuromarkers of SSC. This protocol and other ongoing projects stemming from this research are outlined in Appendix 5. 
